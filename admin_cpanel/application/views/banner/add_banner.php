						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."banner/add_banner"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									...
									<div class="col-sm-5">										
										<select name="banner_type" class="selectboxit">
											...
											<option value="SEARCH_BANNER" data-iconurl="" >SEARCH SLIDER</option>
										</select>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="title" placeholder="Banner Name" data-validate="required" data-message-required="Please enter the Banner Name">
									</div>
								</div>
								<div class="form-group">
									<label for="field-2" class="col-sm-3 control-label">Banner Image Alternative text</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-2" name="img_alt_text" placeholder="Banner Image Alternative Text" data-validate="required" data-message-required="Please enter the Banner Image Alternative Text">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="position" placeholder="Banner Position" data-validate="required,number" data-message-required="Please enter the Banner Position">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">										
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" data-trigger="fileinput">
												<img src="<?php echo base_url(); ?>assets/images/logo.jpg" alt="Banner Image">
											</div>
							...
							<!--	<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="slogan_english" name="slogan_english" placeholder="Banner Slogan" data-validate="required" data-message-required="Please enter the Banner Slogan">
									</div>
								</div>
								<div class="form-group">
									<label for="slogan_polish" class="col-sm-3 control-label">Banner Slogan(Polish)</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="slogan_polish" name="slogan_polish" placeholder="Banner Slogan" data-validate="required" data-message-required="Please enter the Banner Slogan">
									</div>
								</div>
								<div class="form-group">
									<label for="slogandesc_english" class="col-sm-3 control-label">Banner Slogan Description(English)</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="slogandesc_english" name="slogandesc_english" placeholder="Banner Slogan Description" data-validate="required" data-message-required="Please enter the Banner Slogan Description">
									</div>
								</div>
								<div class="form-group">
									<label for="slogandesc_polish" class="col-sm-3 control-label">Banner Slogan Description(Polish)</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="slogandesc_polish" name="slogandesc_polish" placeholder="Banner Slogan Description" data-validate="required" data-message-required="Please enter the Banner Slogan Description">
									</div>
								</div>-->
								<div class="form-group">
