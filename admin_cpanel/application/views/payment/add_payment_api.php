...
<head>
	...
	<title><?php echo PAGE_TITLE; ?> | Payment API</title>	
	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?>  <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Add New Paymnet API</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."payment/add_payment_api"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="fixed_charge" placeholder="Charges Fixed" >
									</div>
								</div>
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Charges Percentage</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" name="percentage_charge" placeholder="Charges Percentage" >
									</div>
								</div>
								<div class="form-group">
