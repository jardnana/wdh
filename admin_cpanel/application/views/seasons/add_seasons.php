	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?>  <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Add New Seasons</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" id="tax" name="tax" action="<?php echo site_url()."seasons/add_seasons"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Season Name</label>									
									<div class="col-sm-5"> 
										 <input type="text" class="form-control" name="seasons_name" data-validate="required" data-message-required="Please Enter the Seasons Name" />
									</div>
								</div>	
								...
								<div class="form-group">
									...
									<div class="col-sm-5"> 
										 <input type="text"  data-min-date="<?php echo date('m-d-Y');?>" class="form-control daterange" name="season_date_range" data-validate="required" data-message-required="Please Enter the Seasons Name" />
									</div>
								</div>	
