				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">
							<?php $table_id = $category_id.'_id'; ?>							
							<form method="post" action="<?php echo site_url()."bestprice_deals/update_deal/".base64_encode(json_encode($deal[0]->$table_id))."/".base64_encode(json_encode($category_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">	
									...
									<div class="col-sm-5">										
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" data-trigger="fileinput">
												<img src="<?php echo $deal[0]->link; ?>" alt="Hotel Image">
											</div>
