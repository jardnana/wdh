...
<head>
	...
	<title><?php echo PAGE_TITLE; ?> | Manage Payment API</title>	
	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?> sidebar-collapsed">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Manage Payment API</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">
							<form id="rootwizard" action="<?php echo site_url()."management/payment_api_management"; ?>" method="post" action="" class="form-wizard form-horizontal form-groups-bordered validate" enctype= "multipart/form-data" >
								<div class="steps-progress"><div class="progress-indicator"></div></div>
								<ul>
									<li class="active"><a href="#tab4" data-toggle="tab"><span>1</span>Payment Api Management</a></li>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab4">
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select name="payment_api" class="selectboxit">
									...
									<div class="tab-pane" id="tab5">
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select name="doamin[]" class="select2" multiple>
									...
									<div class="tab-pane" id="tab6">
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select name="product[]" class="select2" multiple>
										...
										<div class="form-group">
											...
											<div class="col-sm-3 pull-right">
												<button type="submit" class="btn btn-success">Manage Payment API Details</button>
											</div>
										</div>
									</div>
