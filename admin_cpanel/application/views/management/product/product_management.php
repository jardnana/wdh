				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">
							<form id="rootwizard" action="<?php echo site_url()."management/product_management"; ?>" method="post" class="form-wizard form-horizontal form-groups-bordered validate" enctype= "multipart/form-data" >
								<div class="steps-progress"><div class="progress-indicator"></div></div>
								<ul>
									<li class="active"><a href="#tab5" data-toggle="tab"><span>1</span>Product Management</a></li>
									<li ><a href="#tab6" data-toggle="tab"><span>2</span>Domain Management</a></li>
								</ul>
								<div class="tab-content">
									<div class="tab-pane active" id="tab5">										
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select name="product" class="selectboxit">
									...
									<div class="tab-pane" id="tab6">
										...
										<div class="form-group">
											...
											<div class="col-sm-3 pull-right">
												<button type="submit" class="btn btn-success">Manage Product Details</button>
											</div>
										</div>
									</div>
