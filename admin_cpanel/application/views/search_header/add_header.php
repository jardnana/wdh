	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?> sidebar-collapsed">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Add New Header Menu</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."header/add_search_header_menu"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Header Menu Name</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="menu_name" placeholder="Menu Name" data-validate="required" data-message-required="Please enter the Menu Name">
									</div>
								</div>
								<div class="form-group">
									<label for="field-2" class="col-sm-3 control-label">Menu Icon</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-2" name="menu_icon" placeholder="Menu Icon">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group" id="api_url" style="display:none;">
									<label for="field-3" class="col-sm-3 control-label">API URL</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-3" name="menu_url" placeholder="Menu URL" data-validate="required" data-message-required="Please enter the proper Menu URL">
									</div>
								</div>
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Menu Position</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-p" name="position" placeholder="Menu Position" data-validate="required" data-message-required="Please enter the Menu Position">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button type="submit" class="btn btn-success">Add Menu Details</button>
									</div>
								</div>
							</form>
						</div>
