	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?> <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Edit Social Link</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" name="social" id="social" action="<?php echo site_url()."social/update_social_link/".base64_encode(json_encode($links_list[0]->social_link_details_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Title</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="social_link_title" maxlength="50" name="social_link_title" placeholder="Deal Title" data-validate="required" value="<?php echo $links_list[0]->social_link_name; ?>" data-message-required="Please enter the Deal Title">
									</div>
								</div>
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Link</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" name="social_link"   id="social_link" maxlength="150" placeholder="Social Link"  data-message-required="Please enter the Social Link" value="<?php echo $links_list[0]->link; ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Position</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" name="position" id="position" placeholder="Position" maxlength="3" data-validate="number" data-message-required="Please enter the Social Link Position" value="<?php echo $links_list[0]->position; ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Link Icon Class</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control"  id="social_link_icon" name="social_link_icon" maxlength="150" placeholder="Social Link Icon" data-validate="required" data-message-required="Please enter the Social Link Icon Class" value="<?php echo $links_list[0]->icon; ?>">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
											<input type="checkbox" name="status" value="<?php echo $links_list[0]->status ; ?>" id="status" <?php if($links_list[0]->status == "ACTIVE"){ echo "checked"; } ?>>
										</div>
									</div>
								</div>
								<div class="form-group">
