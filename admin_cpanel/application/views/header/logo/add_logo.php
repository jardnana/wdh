	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?> sidebar-collapsed">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Add New Logo</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."header/add_logo"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Logo Name</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="logo_name" placeholder="Logo Name" data-validate="required" data-message-required="Please enter the Logo Name">
									</div>
								</div>
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Logo URL</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-3" name="logo_url" placeholder="Logo URL" data-message-required="Please enter the proper Logo URL">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Date Range</label>									
									<div class="col-sm-5">										
										<input type="text" class="form-control daterange" name="date_rane" id="date_rane" data-min-date="<?php echo date('m-d-Y');?>" />										
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Site Logo Upload</label>									
									<div class="col-sm-5">										
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
											<input type="checkbox" name="logo_status" value="ACTIVE" id="logo_status" checked>
										</div>
									</div>
								</div>								
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button type="submit" class="btn btn-success">Add Logo Details</button>
									</div>
								</div>
							</form>
						</div>
