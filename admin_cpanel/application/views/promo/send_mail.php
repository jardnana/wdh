				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form  id="product" method="post" action="<?php echo site_url()."promo/send_mail_user_new/".$promo[0]->promo_code_details_id; ?>" class="form-horizontal form-groups-bordered validate">				
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">							
										<div class='checkbox'>
                              				<label><input type='checkbox' value='b2c' name="b2c">B2C All Users </label>
                            		     </div>
                            		    <div class='checkbox'>
