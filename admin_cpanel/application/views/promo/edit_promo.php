...
<body id="top" oncontextmenu="return false" class="page-body <?php if(isset($transition)){ echo $transition; } ?>" data-url="<?php echo PROVAB_URL; ?>">
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?> <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Edit sPromo Code</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form id="api" method="post" action="<?php echo site_url()."promo/update_promo/".base64_encode(json_encode($promo[0]->promo_code_details_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<?php if($supplier_rights == 1) { ?>
							...
							<?php } ?>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="promo_code" maxlength="15" name="promo_code" placeholder="Promo Code" data-validate="required" data-message-required="Please enter the Promo Code" value="<?php echo $promo[0]->promo_code; ?>">
									</div>
								</div>
								<div class="form-group">
											<label for="promo_type"  class="col-sm-3 control-label">Promo Code Type</label>									
											<div class="col-sm-5">
												<select name="promo_type" id="promo_type" class="selectboxit">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="discount" maxlength="7" name="discount" value="<?php echo $promo[0]->discount; ?>" placeholder="Discount in %" data-validate="required" data-message-required="Please enter the discount">
									</div>
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Expiry Date</label>									
									<div class="col-sm-5">
										<input type="text" id="exp_date" class="form-control datepicker" name="exp_date"  value="<?php echo date_format(date_create($promo[0]->exp_date), "m/d/Y"); ?>" placeholder="Expiry Date" data-validate="required" data-message-required="Please enter the expiry date">
									</div>
								</div>
								...
								<div class="form-group"  id="amt" style="display:none;">
									...
									<div class="col-sm-5">
										<input type="text" id="amount" class="form-control"  name="amount"  maxlength="10" placeholder="" value="<?php echo $promo[0]->promo_amount; ?>" data-validate="required" data-message-required="Please enter the discount amount">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
											<input type="checkbox" name="promo_status" id="promo_status"  value="<?php echo $promo[0]->status; ?>" <?php if($promo[0]->status == 'ACTIVE') echo "checked"; ?>  >
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button type="submit" class="btn btn-success">Edit Promo Code</button>
									</div>
								</div>
							</form>
						</div>
	...
	<script>
		...
		<?php if($promo[0]->promo_type != '') {
			 if($promo[0]->promo_type !=  'Promo code by %') { ?>
			 ...
			 $('#promo_type').val('<?php echo $promo[0]->promo_type; ?>')
		 <?php  } ?>
