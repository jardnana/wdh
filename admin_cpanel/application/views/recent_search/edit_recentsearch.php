				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">	
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										foreach($city_from as $from){ ?>
											<option value="<?php echo $from->cityCode; ?>" <?php if($deal[0]->deal_from_place==$from->cityCode) echo 'Selected'; ?>><?php echo $from->cityName; ?></option>
										<?php } */ ?> -->
										</select>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										foreach($city_to as $to){ ?>
											<option value="<?php echo $to->cityCode; ?>" <?php if($deal[0]->deal_to_place==$to->cityCode) echo 'Selected'; ?>><?php echo $to->cityName; ?></option>
										<?php } */ ?> -->
										</select>
									</div>
								</div>
									...
									<div class="col-sm-5">										
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" data-trigger="fileinput">
												<img src="<?php echo base_url(); ?>uploads/flight_deals/<?php echo $deal[0]->link; ?>" alt="Hotel Image">
											</div>
