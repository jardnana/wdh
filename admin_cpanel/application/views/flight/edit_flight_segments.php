					...
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."flight/update_flight_segment_data/".base64_encode(json_encode($flight_segments_id))."/".base64_encode(json_encode($flight_segments[0]->flight_crs_id))."/".base64_encode(json_encode($flight_segments[0]->flight_id))."/".base64_encode(json_encode($flight_segments[0]->journey_type)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Marketing Airline Name</label>	
									<div class="col-sm-5">							
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="flight_equipment" value="<?php echo $flight_segments[0]->Equipment; ?>" style='text-transform:uppercase' id ="" maxlength="5"  size="3" type="text" class="form-control"  placeholder="Flight Equipment">
								...
								<div class="form-group">
					                ...
					                <div class="input-group clockpicker pull-center" data-placement="left" data-align="top" data-autoclose="true">
					                    <input type="text" class="form-control" name="start_time" value="<?php echo $departure_date_time[1]; ?>" style="height: 30px;" readonly>
								...
								<div class="form-group">
					                ...
					                <div class="col-sm-3">                     
					                <div class="input-group clockpicker pull-center" data-placement="left" data-align="top" data-autoclose="true">
					                    <input type="text" class="form-control" name="arrival_time" value="<?php echo $arrival_date_time[1]; ?>" style="height: 30px;" readonly>
					                    <span class="input-group-addon">
					                            <span class="glyphicon glyphicon-time"></span>
					                    </span>
					                </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input value="<?php echo $flight_segments[0]->ResBookDesigCode; ?>" name="design_code"  id ="" style='text-transform:uppercase' maxlength="1"  size="1"  type="text" class="form-control"  placeholder="Booking Design Code">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input value="<?php echo $flight_segments[0]->Meal; ?>" name="meal"  id ="" maxlength="1" style='text-transform:uppercase' size="1"  type="text" class="form-control"  placeholder="Meal Code">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<textarea value="<?php echo $flight_segments[0]->Weight_Allowance; ?>" name="weight_allowance" id =""  type="text" class="form-control"  placeholder="weight allowance"><?php echo $flight_segments[0]->Weight_Allowance; ?></textarea>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
									   <input value="<?php echo $flight_segments[0]->max_stop; ?>" name="max_stop" id =""  type="text" class="form-control"  placeholder="Max Stop" >
									</div>
						...
						<!--	<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="select2" name="flight_class" required>
