...
<head>
	...
	<title><?php echo PAGE_TITLE; ?> | Add Flight Price Management</title>	
	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?>  <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Add Flight Price</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" id="price" name="price" action="<?php echo site_url()."flight/add_flight_pricing_data/".base64_encode(json_encode($flight_id))."/".base64_encode(json_encode($flight_crs_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Seasons Name</label>									
									<div class="col-sm-5">								
									<select name="marketing_airline" id="seasons_details_id" class="select2" >
											<option value=""/>
											<?php if($seasons_list!=''){ for($ad=0;$ad<count($seasons_list);$ad++){ ?>
											<option value="<?php echo $seasons_list[$ad]->seasons_details_id; ?>" data-iconurl=""><?php echo $seasons_list[$ad]->seasons_name." (".$seasons_list[$ad]->season_date_range.")"; ?></option>
											<?php }} ?>
									</select>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input name="adult_price" id ="adult_price" onkeypress="return isNumberKey(event)" maxlength="10" minlength="2" data-rule-number='true' min="1" type="text" class="form-control"  placeholder="Adult Price" required>
									</div>
								</div>	
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Adult Price</label>									
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="adult_tax" id ="adult_tax" onkeypress="return isNumberKey(event)"  maxlength="10" minlength="0" data-rule-number='true' min="0" type="text" class="form-control"  placeholder="Adult tax" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="child_price" id ="child_price" onkeypress="return isNumberKey(event)" maxlength="10" minlength="1" data-rule-number='true' min="1" type="text" class="form-control"  placeholder="Child Price" >
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="child_tax" id ="child_tax" onkeypress="return isNumberKey(event)" maxlength="10" minlength="0" data-rule-number='true' min="0" type="text" class="form-control"  placeholder="Child Tax">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="infant_price" id ="infant_price" onkeypress="return isNumberKey(event)" maxlength="10" minlength="1" data-rule-number='true' min="1" type="text" class="form-control"  placeholder="Infant Price">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="infant_tax" id ="infant_tax" onkeypress="return isNumberKey(event)" maxlength="10" minlength="0" data-rule-number='true' min="0" type="text" class="form-control"  placeholder="Infant Tax">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="fare_code" id ="fare_code"  min="0" type="text" class="form-control"  placeholder="Fare Basis Code">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<textarea name="fare_rules" id ="fare_rules"    min="0" type="text" class="input-long ckeditor"  placeholder="Fare Rules"></textarea>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button type="submit" class="btn btn-success">Add Flight Pricing</button>
									</div>
								</div>
							</form>
						</div>
