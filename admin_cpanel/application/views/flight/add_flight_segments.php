						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."flight/add_flight_segment_data/".base64_encode(json_encode($flight_id))."/".base64_encode(json_encode($flight_crs_id))."/".base64_encode(json_encode($trip_type)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input name="flight_equipment" style='text-transform:uppercase' id ="" maxlength="5"  size="3" type="text" class="form-control"  placeholder="Flight Equipment">
							...
							<div class="form-group">
					                ...
					                <div class="input-group clockpicker pull-center" data-placement="left" data-align="top" data-autoclose="true">
					                    <input type="text" class="form-control" name="start_time" value="" style="height: 30px;" readonly >
							...
							<div class="form-group">
					                ...
					                <div class="col-sm-3">                     
					                <div class="input-group clockpicker pull-center" data-placement="left" data-align="top" data-autoclose="true">
					                    <input type="text" class="form-control" name="arrival_time" value="" style="height: 30px;" readonly>
					                    <span class="input-group-addon">
					                            <span class="glyphicon glyphicon-time"></span>
					                    </span>
					                </div>
							...
							<div class="form-group">
									...
									<div class="col-sm-5">
									    <input name="design_code"  id ="" style='text-transform:uppercase' maxlength="1"  size="1"  type="text" class="form-control"  placeholder="Booking Design Code">
									</div>
							...
							<div class="form-group">
									...
									<div class="col-sm-5">
									    <input name="meal"  id ="" maxlength="1" style='text-transform:uppercase' size="1"  type="text" class="form-control"  placeholder="Meal Code">
									</div>
							...
							<div class="form-group">
									...
									<div class="col-sm-5">
									    <textarea name="weight_allowance" id =""  type="text" class="form-control"  placeholder="weight allowance"></textarea>
									</div>
							...
							<div class="form-group">
									...
									<div class="col-sm-5">
									   <input name="max_stop" id =""  type="text" class="form-control"  placeholder="Max Stop">
									</div>
