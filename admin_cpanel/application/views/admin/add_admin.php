...
<head>
	...
	<title><?php echo PAGE_TITLE; ?> | Add Admin</title>	
				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">
							<form id="rootwizard" action="<?php echo site_url()."admin/add_admin"; ?>" method="post" class="form-wizard form-horizontal form-groups-bordered validate" enctype= "multipart/form-data" >
								...
								<div class="tab-content">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<div class="input-group">
													...
													<input type="text" class="form-control" id="field-p" name="phone_no" placeholder="Phone Number" data-validate="number" data-message-required="Please enter the Phone Number">
												</div>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
													<input type="checkbox" name="admin_status" value="ACTIVE" id="admin_status" checked>
												</div>
											</div>
										</div>
										<div class="form-group">
									...
									<div class="tab-pane" id="tab_roles">
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select name="role_id" class="select2" required>
													...
													<option value="<?php echo $admin_type[$a]->role_details_id; ?>" data-iconurl=""><?php echo $admin_type[$a]->role_name;; ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-5">
												<button type="submit" class="btn btn-success">Add Admin Details</button>
											</div>
										</div>
									</div>
