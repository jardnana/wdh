				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."flash/add_flash"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Flash Title</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="flash_title" placeholder="Flash Title" data-validate="required" data-message-required="Please enter the Flash Title">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select onchange="flash_type_type_details(this.value)" name="flash_type" class="select2" required>
											...
											<option value="CITY" data-iconurl="">CITY</option>
										</select>
									</div>
								</div>
								<div class="form-group" id="city_details">
									...
									<div class="col-sm-5">
										<input type="text" id="city_name" name="city_name" class="form-control" placeholder="Type City Name" required />
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="duration" placeholder="Flash duration in Seconds" data-validate="required,number" data-message-required="Please enter the Flash duration in Seconds">
									</div>
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Flash Link</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="link" placeholder="Flash Link" >
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
											<input type="checkbox" name="flash_status" value="ACTIVE" id="flash_status" checked>
										</div>
									</div>
								</div>
								<div class="form-group">
