...
<body id="top" oncontextmenu="return false" class="page-body <?php if(isset($transition)){ echo $transition; } ?>" data-url="<?php echo PROVAB_URL; ?>">
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?> <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Edit Email Template</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form id="email" method="post" action="<?php echo site_url()."email/update_mail_template/".base64_encode(json_encode($email_template[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<!--<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" maxlength="70" value="<?php //echo $email_template[0]->email_bcc; ?>" id="email_bcc" name="email_bcc" placeholder="Email BCC" data-validate="email" data-message-required="Please enter the proper Email">
									</div>
								</div>-->
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">Email Subject</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" maxlength="150" value="<?php echo $email_template[0]->subject; ?>" name="subject" id="subject" placeholder="Email Subject" >
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button type="submit" class="btn btn-success">Update Email Template Details</button>
									</div>
								</div>
							</form>
						</div>
	...
	<script>
		...
		$('#email').submit(function() {				
			var regex =  /^[a-zA-Z0-9 @#$%^&*!]*$/;
			 if($('#subject').val() == '') {
				 $('#subject').css('border', '1px solid #f52c2c');
				 return false;			
			 }		
		 });		 
		});
