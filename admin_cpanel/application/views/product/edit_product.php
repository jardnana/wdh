...
<head>
	...
	<title><?php echo PAGE_TITLE; ?> | Edit Product</title>	
				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form id="product" method="post" action="<?php echo site_url()."product/update_product/".base64_encode(json_encode($product[0]->product_details_id)); ?>" class="form-horizontal form-groups-bordered validate">				
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Product Name</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="product_name" value="<?php echo $product[0]->product_name; ?>" data-validate="required" data-message-required="Please enter the Product Name">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
											<input type="checkbox" name="product_status" value="<?php echo $product[0]->product_status; ?>" id="domain_status" <?php if($product[0]->product_status == "ACTIVE"){ ?>checked <?php } ?>>
										</div>
									</div>
								</div>
								<div class="form-group">
