							...
							<form method="post" id="price" name="price" action="<?php echo site_url()."flight/add_flight_pricing_data/".base64_encode(json_encode($flight_id))."/".base64_encode(json_encode($flight_crs_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									...
									<select name="currency" class="select2" required>
											...
											<option value="<?php echo $currency_list[$ad]->currency_code; ?>"  data-iconurl=""><?php echo $currency_list[$ad]->currency_name; ?></option>
											<?php }} ?>
										</select>
									</div>
								</div>	
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<textarea name="fare_rules" id ="fare_rules"    min="0" type="text" class="form-control"  placeholder="Fare Rules"></textarea>
