				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."api/update_api/".base64_encode(json_encode($api[0]->api_details_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-4" name="api_user_name" value="<?php echo $api[0]->api_username; ?>" data-validate="required" data-message-required="Please enter the API Username">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-3" name="api_url" value="<?php echo $api[0]->api_url; ?>" data-validate="required,url" data-message-required="Please enter the proper API URL">
									</div>
								</div>
								<div class="form-group">
									<label for="field-3" class="col-sm-3 control-label">API URL1</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-6" name="api_url1" value="<?php echo $api[0]->api_url1; ?>" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">										
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<div class="fileinput-new thumbnail" data-trigger="fileinput">
												<img src="<?php echo base_url(); ?>uploads/api/<?php echo $api[0]->api_logo; ?>" alt="API Logo">
											</div>
