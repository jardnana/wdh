...
<head>
	...
	<title><?php echo PAGE_TITLE; ?> | Block List</title>	
	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?>  <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Add New Block List</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."blocklist/add_block_list"; ?>" class="form-horizontal form-groups-bordered validate">				
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Block List  Name</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-1" name="block_list_name" placeholder="Block List Name" data-validate="required" data-message-required="Please enter the Block List Name">
									</div>
								</div>								
								<div class="form-group">
									...
									<div class="col-sm-5">
										<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
											<input type="checkbox" name="block_list_status" value="ACTIVE" id="block_list_status" checked>
										</div>
									</div>
								</div>								
								<div class="form-group">
