	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?> sidebar-collapsed">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active"><strong>Add New Privilege</strong></li>
			</ol>
			<div class="row">
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."privilege/add_privilege"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Role Name </label>									
									<div class="col-sm-5">
										<select name="block_list" class="selectboxit">
											<?php if($roles_list!=''){ for($a=0;$a<count($roles_list);$a++){ ?>
											<option value="<?php echo $roles_list[$a]->role_details_id; ?>" data-iconurl="<?php echo base_url(); ?>uploads/roles/<?php echo $roles_list[$a]->role_logo; ?>"><?php echo $roles_list[$a]->role_name; ?></option>
											<?php }} ?>
										</select>
									</div>
								</div>	
