						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."markup/add_markup"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="domain[]" class="select2" multiple required>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<select name="journey_type" class="select2" >
												<option value="ALL" data-iconurl="">ALL</option>
												<option value="ONEWAY" data-iconurl="">ONEWAY</option>
												<option value="ROUNDTRIP" data-iconurl="">ROUNDTRIP</option>
												<option value="MULTICITY" data-iconurl="">MULTICITY</option>
											</select>
										</div>
									</div>
									<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-mv" name="markup_value" placeholder="Markup Value" data-message-required="Please enter the Markup Value">
									</div>
								</div>
								<div class="form-group">
									<label for="field-2" class="col-sm-3 control-label">Markup Value Fixed</label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-mf" name="markup_fixed" placeholder="Markup Fixed"  data-message-required="Please enter the Markup Fixed">
									</div>
								</div>	
								<div class="form-group">
