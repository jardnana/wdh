<?php
class Bestpricedeal_Model extends CI_Model {
	...
	function get_deals_list($table_name){
		$this->db->select('*');
		...
		function get_deals_list_from_table($id, $table_name){
	...
	function add_deal($input, $table_name, $image_name){
		if(!isset($input['status']))
			$input['status'] = "INACTIVE";
	...
	function inactive_deal($id,$table_name){
		$id_name =$table_name.'_id';
		$data = array(
					'status' => 'INACTIVE'
					);
	...
	function active_deal($id,$table_name){
		$id_name =$table_name.'_id';
		$data = array(
					'status' => 'ACTIVE'
					);
	...
	function update_deal($update, $id, $table_name,$image_name){
		$id_name =$table_name.'_id';
	...
	function delete_deal($id,$table_name){
		$id_name =$table_name.'_id';
		$this->db->where($id_name, $id);
